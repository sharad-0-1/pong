...
function love.update(dt)
    ...
    -- player 2 movement
    if ball.y - player2.y - 8 < 4 and ball.y - player2.y - 8 > - 4 then
        player2.dy = math.random(1) * player2.dy / 50
    elseif ball.y - player2.y - 8 > 0 then
        player2.dy = math.random(math.random(3)) == 1 and PADDLE_SPEED or (0)
    elseif ball.y - player2.y - 8 < 0 then
        player2.dy = - (math.random(math.random(3)) == 1 and PADDLE_SPEED or (0))
    else
        player2.dy = math.rando(1) * player2.dy / 50
    end
